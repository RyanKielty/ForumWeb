...
//    static ArrayList<Message> messages = new ArrayList<>();
    ...
    static void addTestMessages(Connection conn) throws SQLException {
        insertMessage(conn, 1, -1, "Hello Bitches!");
        insertMessage(conn, 2,-1, "This thread is fucking dope!");
        insertMessage(conn, 3,1, "Cool thread Alice!");
        insertMessage(conn, 1,3,"Thanks dude!");
    }
    ...
    public static void createTables(Connection conn) throws SQLException {
        ...
        stmt.execute("CREATE TABLE IF NOT EXISTS messages " +
                "(id IDENTITY, user_id INT, reply_id INT, text VARCHAR)");
